...
time hpcrun -o hpctoolkit-euler3d-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer@50 ./euler3d ../data/fvcorr.domn.097K &>log
hpcstruct ./euler3d
