...
time hpcrun -o hpctoolkit-histogram-measurements -ck HPCRUN_SANITIZER_DEFAULT_TYPE=INT -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer@50 ./histogram &> log 
hpcstruct ./histogram
