...
time hpcrun -o hpctoolkit-backprop-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer ./backprop 65536 &> log
#hpcstruct ./backprop
