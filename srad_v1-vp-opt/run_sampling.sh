...
time hpcrun -o hpctoolkit-srad-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer@50 ./srad 1 0.5 502 458 &>log
hpcstruct ./srad
