...
time hpcrun -o hpctoolkit-hotspot-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer@50 ./hotspot 512 2 2 ../data/temp_512 ../data/power_512 output.out &> log 
hpcstruct ./hotspot
