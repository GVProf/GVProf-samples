 ...
 */
__global__ void
vectorAdd(const unsigned long long *A, const unsigned long long *B, unsigned long long *C, unsigned long long numElements)
{
...
main(void)
{
    ...
    int numElements = 1;
    size_t size = numElements * sizeof(unsigned long long);
    ...
    // {
    //     h_A[i] = rand()/(unsigned long long)RAND_MAX;
    //     h_B[i] = rand()/(unsigned long long)RAND_MAX;
    // }
    h_A[0] = 0.123456789;
    h_B[0] = 1;
