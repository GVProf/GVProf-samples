...
time hpcrun -o hpctoolkit-bfs-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer@50 ./bfs ../data/graph1MW_6.txt &> log
hpcstruct ./bfs
